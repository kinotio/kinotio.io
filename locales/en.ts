export default {
  ...
  benefits: {
    ...
    parteners: 'parteners',
    description:
      'By partnering with and sponsoring an open source community, organizations can not only drive innovation and efficiency but also strengthen their market position and reputation.',
    financial_benefits: {
  ...
  features: {
    ...
    different: 'Different',
    description:
      "We are thrilled to introduce our open source developer community, a vibrant and inclusive hub for innovation, collaboration, and growth. Here's what sets us apart and why you should join us.",
    diversity_inclusion: {
